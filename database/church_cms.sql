...
CREATE TABLE IF NOT EXISTS `attendance_snapshots` (
  ...
  `session_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'main_service',
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_attendance_snapshots_event` (`event_id`),
  KEY `idx_attendance_snapshots_date` (`service_date`),
  KEY `idx_attendance_snapshots_type` (`service_type`),
  KEY `idx_attendance_snapshots_session_type` (`session_type`),
